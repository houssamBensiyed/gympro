 ...
 * Delete Equipment Page - Modern Tailwind CSS
 * ============================================
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result) {
        setFlashMessage('success', 'Equipment "' . $equipment['name'] . '" deleted successfully.');
    } else {
        setFlashMessage('error', 'Failed to delete equipment.');
    }
    
    redirect(url('/equipment/'));
}

$pageTitle = 'Delete Equipment';
...
<div class="mb-8">
    ...
    <h1 class="text-lg font-semibold tracking-tight text-white">Delete Equipment</h1>
</div>
...
<div class="max-w-xl">
    <div class="bg-slate-800/50 backdrop-blur-sm rounded-lg border border-rose-500/30 overflow-hidden">
        ...
        <div class="p-6">
            <p class="text-slate-300 mb-6">Are you sure you want to delete this equipment? This action cannot be undone.</p>
            ...
            <div class="bg-slate-900/50 rounded-lg p-4 mb-6 space-y-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-xs font-medium text-dark-500 uppercase tracking-wider mb-1">Equipment Name</p>
                        <p class="text-sm text-white font-medium"><?php echo e($equipment['name']); ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-white"><?php echo $equipment['quantity']; ?> units</p>
                    </div>
                </div>
            </div>
            
            <?php if ($equipment['courses_count'] > 0): ?>
            <div class="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 mb-6">
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm text-amber-200">
                        This equipment is linked to <strong><?php echo $equipment['courses_count']; ?></strong> course(s). 
                        Deleting it will remove all course assignments.
                    </p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <form action="" method="POST">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo url('/equipment/view.php?id=' . $equipmentId); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-dark-800 hover:bg-slate-600 text-white font-medium rounded-lg transition-colors">
